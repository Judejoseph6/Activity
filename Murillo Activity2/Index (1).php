...
mysqli_select_db($form, 'murilloform') or die(mysqli_error($form));
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO regform (Email, Username, Pass, User, Sex) 
              VALUES ('$email', '$username', '$password', '$user', '$sex')";
        ...
        <form action="" method="post">
            <div class="form">
                ...
                <div class="input">
                    ...
                    <input type="text" placeholder="Name" name="username" id="name" class="info"><br>
                </div>
                <div class="input">
